...
비록 간단한 프로젝트이지만, 그동안 학습한 내용을 복습하고 스스로 한 단계 성장할 수 있었던 소중한 경험이었습니다. 자바와 스프링을 꾸준히 공부하면서도 방대한 학습량 때문에 제 이해도를 점검할 시점이 필요했는데, 이번 프로젝트를 직접 구현해 보며 제게 부족했던 부분들을 확실히 알 수 있었습니다. 개발을 진행하면서 막연하게 알고 있던 개념들을 더 깊이 이해하고, 잘못 알고 있던 내용들을 바로잡는 과정을 통해 "학습한 내용을 실제로 개발해 보는 것이 무엇보다 중요하다"는 것을 깨달았습니다. 특히 제가 짠 코드를 타인에게 테스트 맡겨 보았을 때 고쳐야 할 점이 많이 발견되면서 테스트의 중요성을 몸소 느꼈으며, 이러한 피드백을 바탕으로 프로젝트를 개선해 나가는 과정에서 많은 성장을 이룰 수 있었습니다. 앞으로 스프링에 대해 더 깊이 공부하고 JPA 등 새로운 기술들을 꾸준히 학습해 나가면서, 배운 것들을 접목해 이 프로젝트를 계속 발전시켜 나갈 계획입니다. 
